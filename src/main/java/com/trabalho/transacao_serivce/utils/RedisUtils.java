...
public class RedisUtils {
    ...
    public TransacaoSaldoStatusDTO decrement(Long idUsuario, BigDecimal valor, TipoConta tipoConta){
    ...
    public boolean isValidTransacao(String chave, BigDecimal valor, TipoConta tipoConta) {
